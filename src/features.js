  ...
  return (
    <div style={{ background:"linear-gradient(135deg,#FFF8F0,#FFF3E0)",borderRadius:16,padding:16,marginTop:12,marginBottom:12,border:"1px solid rgba(231,111,81,0.2)" }}>
      ...
      <div style={{ background:"#FFFFFF",border:"1px solid rgba(214,40,40,0.18)",borderRadius:10,padding:10 }}>
        <div style={{ fontSize:12,fontWeight:700,color:"#7F1D1D",marginBottom:4 }}>Delaware County Crisis Connections Team: 855-889-7827</div>
        <div style={{ fontSize:11,color:"#7F1D1D",lineHeight:1.35 }}>If this is an emergency, call 911.</div>
      </div>
    </div>
  );
}
...
export function CrisisEscapePlan({ onClose }) {
  ...
  const fields = [{key:"step1",label:"Step 1 — First call I make",placeholder:"e.g. Call 855-889-7827, call 988, or text PA to 741741"},{key:"step2",label:"Step 2 — First place I go",placeholder:"e.g. 28 Walnut Road, Wallingford (Lifewerks)"},{key:"step3",label:"Step 3 — What I say when I get there",placeholder:"e.g. I need emergency help, I'm not safe at home"},{key:"safeContact",label:"My trusted contact",placeholder:"e.g. Sister Maria"},{key:"safeContactPhone",label:"Their phone number",placeholder:"e.g. 610-555-0000"}];
  return (
