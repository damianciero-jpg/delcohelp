...
export const EXTRA_TRANSLATIONS = {
  vi: {
    ...
    // Home screen
    emergency: "🚨 Tôi Cần Giúp Đỡ Ngay Bây Giờ",
    openRightNow: "● Đang mở ngay bây giờ",
    opensLaterToday: "◐ Mở vào hôm nay",
    closedToday: "○ Đóng cửa hôm nay",
    openNow: "Đang mở",
    allResources: "Tất cả tài nguyên",
    foodHelpMore: "Thực phẩm, trợ giúp và nhiều hơn",
    snapWic: "SNAP, WIC, LIHEAP",
    nutrition: "Dinh dưỡng",
    nutritionSub: "Quét để kiểm tra",
    checkInfo: "Kiểm tra thông tin",
    checkInfoSub: "Phát hiện lừa đảo",
    poweredByClaude: "Dùng Claude",
    crisisHotlines: "Đường dây khủng hoảng",

    // Find screen
    findResources: "Tìm Tài Nguyên",
    searchPlaceholder: "Tìm kiếm theo tên hoặc loại...",
    sortedByDistance: "tài nguyên · sắp xếp theo khoảng cách",

    // Resource detail
    about: "Về chương trình này",
    hours: "Giờ mở cửa",
    whatToKnow: "Điều cần biết",
    call: "Gọi",
    directions: "🗺️ Bản đồ",
    back: "← Quay lại",
    donatePantry: "💛 Quyên góp để hỗ trợ",

    // Benefits screen
    benefitsNav: "Hướng dẫn Quyền lợi",
    benefitsDesc: "Tìm các chương trình bạn có thể đủ điều kiện ở Pennsylvania",
    quickEligibility: "Kiểm tra nhanh điều kiện",
    applyNow: "Đăng ký ngay →",
    learnMore: "Tìm hiểu thêm",

    // Emergency / Hotlines
    emergencyHotlines: "Đường Dây Khẩn Cấp",
    hotlinesDesc: "Trợ giúp ngay lập tức, bất kỳ lúc nào, 24/7",
    confidentialNote: "Tất cả các cuộc gọi đều bảo mật. Bạn không cần cho tên. Luôn có sự giúp đỡ — bạn không đơn độc.",

    // AI screen
    aiChat: "Trợ Lý AI",
    aiDesc: "Hỏi về các tài nguyên địa phương và các chương trình hỗ trợ",
    aiPlaceholder: "ví dụ: Tôi cần thực phẩm tối nay...",
    aiSend: "Gửi",
    aiThinking: "Đang tìm kiếm sự giúp đỡ cho bạn...",
    aiLimit: "Đã đạt giới hạn hôm nay",
    aiLimitDesc: "Bạn đã dùng hết 5 tin nhắn hôm nay. Vui lòng thử lại vào ngày mai.",

    // Impact
    impactDashboard: "Bảng Điều Khiển Tác Động",
    totalUsers: "Tổng người dùng",
    resourcesFound: "Tài nguyên được tìm thấy",
    familiesHelped: "Gia đình được giúp đỡ",
    donationsRaised: "Quyên góp",

    // Submit
    submitResource: "Gửi Tài Nguyên",
    submitDesc: "Biết một chỗ hoặc dịch vụ chúng tôi còn thiếu? Thêm vào đây.",
    orgName: "Tên tổ chức",
    orgAddress: "Địa chỉ",
    orgPhone: "Số điện thoại",
    orgCategory: "Loại",
    orgHours: "Giờ mở cửa / Ngày mở",
    orgNotes: "Ghi chú thêm (tùy chọn)",
    submitThanks: "Cảm ơn! Chúng tôi sẽ xem xét và thêm tài nguyên này trong vòng 24 giờ.",

    // Parish/Church specific
    massesToday: "Thánh Lễ Hôm Nay",
    watchMass: "Xem Thánh Lễ",
    upcomingEvents: "Sự Kiện Sắp Tới",
    rsvp: "Đăng ký tham dự",
    volunteerOpps: "Cơ Hội Tình Nguyện",
    myHours: "Giờ Của Tôi",
    totalHours: "Tổng số giờ",
    impactValue: "Giá trị tác động",
  ...
  zh: {
    ...
    emergency: "🚨 我现在需要帮助",
    openRightNow: "● 现在开放",
    opensLaterToday: "◐ 今天晚些时候开放",
    closedToday: "○ 今天关闭",
    openNow: "现在开放",
    allResources: "所有资源",
    foodHelpMore: "食物、帮助及更多",
    snapWic: "SNAP、WIC、LIHEAP",
    nutrition: "营养",
    nutritionSub: "扫描检查",
    checkInfo: "检查信息",
    checkInfoSub: "识别诈骗",
    poweredByClaude: "由 Claude 提供",
    crisisHotlines: "危机热线",

    // Find screen
    findResources: "查找资源",
    searchPlaceholder: "按名称或类型搜索...",
    sortedByDistance: "资源 · 按距离排序",
    ...
    // Benefits screen
    benefitsNav: "福利导航",
    benefitsDesc: "查找您在宾夕法尼亚州可能符合条件的项目",
    quickEligibility: "快速资格检查",
    applyNow: "立即申请 →",
    learnMore: "了解更多",

    // Emergency / Hotlines
    emergencyHotlines: "紧急热线",
    hotlinesDesc: "全天候即时帮助，24小时服务",
    confidentialNote: "所有电话保密。您无需提供姓名。随时都有帮助——您并不孤单。",

    // AI screen
    aiChat: "AI助手",
    aiDesc: "询问当地资源和支持项目",
    aiPlaceholder: "例如：我今晚需要食物...",
    aiSend: "发送",
    aiThinking: "正在为您寻找帮助...",
    aiLimit: "今日已达上限",
    aiLimitDesc: "您今天已使用5条消息。请明天再试。",

    // Impact
    impactDashboard: "影响力仪表板",
    totalUsers: "总用户数",
    resourcesFound: "找到的资源",
    familiesHelped: "获得帮助的家庭",
    donationsRaised: "筹款金额",

    // Submit
    submitResource: "提交资源",
    submitDesc: "知道我们遗漏的食物储藏室或服务？在这里添加。",
    orgName: "组织名称",
    orgAddress: "地址",
    orgPhone: "电话号码",
    orgCategory: "类别",
    orgHours: "开放时间 / 开放日",
    orgNotes: "附加说明（可选）",
    submitThanks: "谢谢！我们将在24小时内审核并添加此资源。",
...
export function CrisisEscapePlan({ onClose }) {
  ...
  const [, setViewing] = useState(!!getCrisisEscapePlan());
...
/* ═══════════════════════════════════════════════════════════
   HEALTH SCANNER — Traffic Light Food Analyzer
   Barcode scan OR manual text entry
   Static nutrition database — instant, $0 cost, works offline
   ═══════════════════════════════════════════════════════════ */

// Open Food Facts API — free, no key required, massive database
...
function scoreNutrition(product) {
  ...
  const score = { red: 0, yellow: 0, green: 0, reasons: [], positives: [], warnings: [] };

  // Sugar (per 100g)
  const sugar = n["sugars_100g"];
  if (sugar !== undefined) {
    if (sugar > 22.5) { score.red++; score.warnings.push(`High sugar (${sugar.toFixed(1)}g per 100g)`); }
    else if (sugar > 5) { score.yellow++; score.reasons.push(`Moderate sugar (${sugar.toFixed(1)}g per 100g)`); }
    else { score.green++; score.positives.push(`Low sugar`); }
  }

  // Saturated fat (per 100g)
  const satFat = n["saturated-fat_100g"];
  if (satFat !== undefined) {
    if (satFat > 5) { score.red++; score.warnings.push(`High saturated fat (${satFat.toFixed(1)}g per 100g)`); }
    else if (satFat > 1.5) { score.yellow++; score.reasons.push(`Moderate saturated fat (${satFat.toFixed(1)}g per 100g)`); }
    else { score.green++; score.positives.push(`Low saturated fat`); }
  }

  // Salt/sodium (per 100g)
  const salt = n["salt_100g"];
  if (salt !== undefined) {
    if (salt > 1.5) { score.red++; score.warnings.push(`High salt (${salt.toFixed(1)}g per 100g)`); }
    else if (salt > 0.3) { score.yellow++; score.reasons.push(`Moderate salt (${salt.toFixed(1)}g per 100g)`); }
    else { score.green++; score.positives.push(`Low salt`); }
  }

  // Fiber (per 100g) — positive
  const fiber = n["fiber_100g"];
  if (fiber !== undefined) {
    if (fiber >= 3) { score.green++; score.positives.push(`Good source of fiber (${fiber.toFixed(1)}g per 100g)`); }
  }

  // Protein (per 100g) — positive
  const protein = n["proteins_100g"];
  if (protein !== undefined) {
    if (protein >= 10) { score.green++; score.positives.push(`Good source of protein (${protein.toFixed(1)}g per 100g)`); }
  }

  // Nutri-Score if available
  const nutriScore = product.nutriscore_grade || product.nutrition_grade_fr;
  if (nutriScore) score.nutriScore = nutriScore.toUpperCase();

  // Overall rating
  let rating, color, emoji, label;
  if (score.red >= 2 || (score.red >= 1 && score.yellow >= 2)) {
    rating = "red"; color = "#D62828"; emoji = "🔴"; label = "Limit This";
  } else if (score.red >= 1 || score.yellow >= 2) {
    rating = "yellow"; color = "#C9A84C"; emoji = "🟡"; label = "Eat in Moderation";
  } else {
    rating = "green"; color = "#2D6A4F"; emoji = "🟢"; label = "Good Choice";
  }

  return { ...score, rating, color, emoji, label };
}

// Healthy alternatives by category
const ALTERNATIVES = {
...
export function HealthScreen() {
  const [mode, setMode] = useState("search"); // search | scan | result | loading | error
  ...
  const [history, setHistory] = useState(() => {
    try { return JSON.parse(localStorage.getItem("dh_health_history") || "[]"); }
    catch { return []; }
  });
  ...
  function saveToHistory(prod, sc) {
    const entry = {
      name: prod.product_name || prod.product_name_en || "Unknown",
      brand: prod.brands || "",
      rating: sc.rating,
      emoji: sc.emoji,
      label: sc.label,
    ...
    setHistory(updated);
    try { localStorage.setItem("dh_health_history", JSON.stringify(updated)); } catch {}
  }

  async function searchByName(name) {
    if (!name.trim()) return;
    setMode("loading");
    trackEvent("health_search", { query: name });
    try {
      ...
      if (data.products && data.products.length > 0) {
        ...
        const sc = scoreNutrition(prod);
        setProduct(prod);
        setScore(sc);
        saveToHistory(prod, sc);
        setMode("result");
      } else {
        setErrorMsg(`No results found for "${name}". Try a different spelling or scan the barcode.`);
        setMode("error");
      }
    } catch(e) {
      setErrorMsg("Couldn't connect to the food database. Check your internet and try again.");
      setMode("error");
    }
  }
  ...
  async function searchByBarcode(code) {
    setMode("loading");
    trackEvent("health_barcode", { barcode: code });
    try {
      ...
      if (data.status === 1 && data.product) {
        const sc = scoreNutrition(data.product);
        setProduct(data.product);
        setScore(sc);
        saveToHistory(data.product, sc);
        setMode("result");
      } else {
        setErrorMsg(`Barcode ${code} not found in the database. Try searching by name instead.`);
        setMode("error");
      }
    } catch(e) {
      setErrorMsg("Couldn't connect to the food database. Check your internet and try again.");
  ...
  async function startCamera() {
    ...
    try {
      ...
      setScanning(false);
      setErrorMsg("Camera access denied. Please enter the barcode number manually below.");
      setMode("error");
    }
  }
  ...
  function NutriBadge({ label, value, unit, thresholdGood, thresholdBad }) {
    ...
    const isGood = value <= thresholdGood;
    const isBad = value >= thresholdBad;
    const color = isBad ? "#D62828" : isGood ? "#2D6A4F" : "#C9A84C";
    return (
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "6px 0", borderBottom: "1px solid rgba(0,0,0,0.05)" }}>
        <div style={{ fontSize: 12, color: "#3A3020" }}>{label}</div>
        <div style={{ fontSize: 12, fontWeight: 700, color }}>{typeof value === 'number' ? value.toFixed(1) : value}{unit}</div>
      </div>
    );
  }
    ...
    <div className="dfi">
      ...
      <div style={{ background: "linear-gradient(160deg,#1A1A2E 0%,#2D5E8F 100%)", padding: "16px 24px 20px", borderRadius: "0 0 28px 28px", marginBottom: 16 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
          ...
          <div>
            <div style={{ fontFamily: "'DM Serif Display',serif", fontSize: 22, color: "white", lineHeight: 1.2 }}>Food Health Checker</div>
        ...
        <div style={{ display: "flex", gap: 12, marginTop: 10 }}>
          {[["🟢","Good Choice"],["🟡","Moderate"],["🔴","Limit This"]].map(([e,l]) => (
            <div key={l} style={{ display: "flex", alignItems: "center", gap: 4, background: "rgba(255,255,255,0.15)", borderRadius: 8, padding: "3px 8px" }}>
              ...
              <span style={{ fontSize: 10, color: "white", fontWeight: 600 }}>{l}</span>
            </div>
          ))}
        </div>
      </div>
        ...
        {(mode === "search" || mode === "error") && (
          <>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <input
                  ...
                  onKeyDown={e => e.key === "Enter" && searchByName(query)}
                  placeholder="e.g. Cheerios, white rice, apple..."
                  style={{ flex: 1, padding: "12px 14px", borderRadius: 12, border: "1.5px solid rgba(0,0,0,0.1)", fontSize: 14, fontFamily: "sans-serif", outline: "none" }}
                />
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 11, color: "#9BA8A0", fontWeight: 600 }}>OR</div>
              <div style={{ flex: 1, height: 1, background: "rgba(0,0,0,0.07)" }} />
            </div>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <button onClick={startCamera} style={{
                width: "100%", background: "linear-gradient(135deg,#1A1A2E,#2D5E8F)", color: "white",
                border: "none", borderRadius: 14, padding: "16px", fontSize: 15, fontWeight: 700,
                cursor: "pointer", fontFamily: "sans-serif", display: "flex", alignItems: "center", justifyContent: "center", gap: 10
              }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <input
                  ...
                  onKeyDown={e => e.key === "Enter" && barcode.length >= 8 && searchByBarcode(barcode)}
                  placeholder="e.g. 012000001765"
                  style={{ flex: 1, padding: "12px 14px", borderRadius: 12, border: "1.5px solid rgba(0,0,0,0.1)", fontSize: 14, fontFamily: "sans-serif", outline: "none" }}
                />
            ...
            {/* Error message */}
            {mode === "error" && (
              <div style={{ background: "#FFF0F0", border: "1px solid rgba(214,40,40,0.2)", borderRadius: 12, padding: 14, marginBottom: 16 }}>
                <div style={{ fontSize: 13, color: "#D62828", fontWeight: 600, marginBottom: 4 }}>⚠ Not Found</div>
                <div style={{ fontSize: 12, color: "#9B1C1C", lineHeight: 1.5 }}>{errorMsg}</div>
              </div>
            )}
            ...
            {history.length > 0 && (
              <div style={{ marginBottom: 20 }}>
                ...
                {history.slice(0, 5).map((h, i) => (
                  <div key={i} onClick={() => h.barcode ? searchByBarcode(h.barcode) : searchByName(h.name)}
                    style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 0", borderBottom: "1px solid rgba(0,0,0,0.05)", cursor: "pointer" }}>
                    <span style={{ fontSize: 16 }}>{h.emoji}</span>
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 13, fontWeight: 600, color: "#1A1A2E" }}>{h.name}</div>
                      <div style={{ fontSize: 10, color: "#9BA8A0" }}>{h.brand} · {new Date(h.date).toLocaleDateString()}</div>
                    </div>
        ...
        {mode === "scan" && (
          <div style={{ marginBottom: 20 }}>
            <div style={{ borderRadius: 16, overflow: "hidden", marginBottom: 12, position: "relative", background: "#000", aspectRatio: "4/3" }}>
              ...
              <div style={{ position: "absolute", bottom: 12, left: 0, right: 0, textAlign: "center", fontSize: 11, color: "white", fontWeight: 600 }}>
                Point camera at the barcode
              </div>
            </div>
            <div style={{ fontSize: 12, color: "#6B7C6E", marginBottom: 12, textAlign: "center" }}>
              Camera scanning coming soon — please enter the barcode number below for now
            </div>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 14, alignItems: "flex-start", marginBottom: 16 }}>
              {product.image_front_small_url && (
                <img src={product.image_front_small_url} alt={productName} style={{ width: 72, height: 72, objectFit: "contain", borderRadius: 12, background: "#F5F5F0", flexShrink: 0 }} />
              )}
              <div style={{ flex: 1 }}>
                ...
                <div style={{
                  ...
                  background: score.rating === "green" ? "#D8F3DC" : score.rating === "yellow" ? "#FFF3CD" : "#FFE8E8",
                  border: `1.5px solid ${score.color}33`,
                  borderRadius: 12, padding: "8px 14px"
                }}>
                  <span style={{ fontSize: 22 }}>{score.emoji}</span>
                  <div>
                    <div style={{ fontSize: 15, fontWeight: 800, color: score.color }}>{score.label}</div>
                    {score.nutriScore && <div style={{ fontSize: 10, color: "#6B7C6E" }}>Nutri-Score: {score.nutriScore}</div>}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div style={{ background: "#F8FAF9", borderRadius: 14, padding: 14, marginBottom: 14, border: "1px solid rgba(0,0,0,0.06)" }}>
                ...
                {score.warnings.map((w, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 6, marginBottom: 4 }}>
                    <span style={{ color: "#D62828", fontWeight: 700, fontSize: 12, marginTop: 1 }}>✗</span>
                    <span style={{ fontSize: 12, color: "#9B1C1C" }}>{w}</span>
                  </div>
                ))}
                {score.reasons.map((r, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 6, marginBottom: 4 }}>
                    <span style={{ color: "#C9A84C", fontWeight: 700, fontSize: 12, marginTop: 1 }}>~</span>
                    <span style={{ fontSize: 12, color: "#7B5800" }}>{r}</span>
                  </div>
                ))}
                {score.positives.map((p, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 6, marginBottom: 4 }}>
                    <span style={{ color: "#2D6A4F", fontWeight: 700, fontSize: 12, marginTop: 1 }}>✓</span>
                    <span style={{ fontSize: 12, color: "#1B4332" }}>{p}</span>
                  </div>
                ))}
              </div>
            )}
              ...
              <div style={{ background: "#F0FBF4", borderRadius: 14, padding: 14, marginBottom: 14, border: "1px solid rgba(45,106,79,0.15)" }}>
                ...
                {alternatives.map((alt, i) => (
                  <div key={i} onClick={() => { setQuery(alt); searchByName(alt); }} style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 0", borderBottom: i < alternatives.length - 1 ? "1px solid rgba(45,106,79,0.08)" : "none", cursor: "pointer" }}>
                    ...
                    <span style={{ fontSize: 13, color: "#1B4332", flex: 1 }}>{alt}</span>
                    <span style={{ fontSize: 10, color: "#2D6A4F", fontWeight: 600 }}>Check this</span>
                  </div>
                ))}
              </div>
            )}
            ...
            {/* Disclaimer */}
            <div style={{ fontSize: 10, color: "#9BA8A0", lineHeight: 1.5, marginBottom: 12, fontStyle: "italic" }}>
              Data sourced from Open Food Facts. Ratings are general guidance only and do not constitute medical or dietary advice. Consult a healthcare provider for personalized nutrition guidance.
            </div>

            {/* Actions */}
            <button onClick={reset} style={{ width: "100%", background: "#2D5E8F", color: "white", border: "none", borderRadius: 12, padding: 14, fontSize: 14, fontWeight: 700, cursor: "pointer", marginBottom: 20, fontFamily: "sans-serif" }}>
              🔍 Check Another Food
            </button>
          </div>
        )}
