...
const T = {
  en: {
    ...
    nutrition:"Nutrition", nutritionSub:"Scan to check", checkInfo:"Check Info", checkInfoSub:"Spot scams", poweredByClaude:"Powered by Claude", crisisHotlines:"Crisis hotlines",
  ...
  es: {
    ...
    nutrition:"Nutrición", nutritionSub:"Escanear comida", checkInfo:"Verificar Info", checkInfoSub:"Detectar estafas", poweredByClaude:"Con Claude", crisisHotlines:"Líneas de crisis",
    ...
    <div className="dfi">
      <div style={{background:"linear-gradient(160deg,#2D6A4F 0%,#40916C 100%)",padding:"16px 24px 24px",borderRadius:"0 0 28px 28px",marginBottom:16}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
          {[{icon:"🔍",label:t.findResources,sub:t.foodHelpMore,nav:"find"},{icon:"📋",label:t.benefits,sub:t.snapWic,nav:"benefits"},{icon:"🥗",label:t.nutrition,sub:t.nutritionSub,nav:"health"},{icon:"🛡️",label:t.checkInfo,sub:t.checkInfoSub,nav:"trust"},{icon:"🤖",label:t.askAI,sub:t.poweredByClaude,nav:"ai"},{icon:"🚨",label:t.emergency,sub:t.crisisHotlines,nav:"hotline"}].map(a=>(
...
export default function App() {
  ...
  const tabs=[
    ...
    {id:"health",icon:"🥗",label:"nutrition"},
